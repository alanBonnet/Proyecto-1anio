                ...
                <div className="container-fluid py-4">
                    ...
                    <div className="col-12 col-md-12">
                        ...
                        <div className="row">
                            <div className="col-3">
                                <p>Habilidades</p>
                                <Group3CheckBoxes name1="Javascript" id1={1} id2={2} id3={3} name2="Python" name3="Habilidades blandas" />
                            </div>
                            <div className="col-3">
                                <p>Experiencia</p>
                                <Group3CheckBoxes name1="Javascript" id1={4} id2={5} id3={6} name2="Python" name3="Liderazgo" />
                            </div>
                            <div className="col-3">
                                {" "}
                                <p>Educacion</p>
                                <Group3CheckBoxes name1="Javascript" id1={7} id2={8} id3={9} name2="Python" name3="C++" />
                            </div>
                            <div className="col-3">
                                <p>Lenguajes</p>
                                <Group3CheckBoxes name1="Inglés" id1={1} id2={2} id3={3} name2="Chino Mandarín" name3="Alemán" />

                            </div>
                        </div>
                        {!isSearching3 ? "" : isLoading3 ? <div className="d-flex justify-content-center mt-5">
                            <div className="spinner-border" role="status">
                                <span className="visually-hidden">Loading...</span>
                            </div>
                        </div> : <div className="alert alert-danger text-center text-white fs-5 mt-5" role="alert">
                            Ingrese un CV con formato PDF
                        </div>
                        }
                        {!isSearching2 ? "" : isLoading2 ? <div className="d-flex justify-content-center mt-5">
                            <div className="spinner-border" role="status">
                                <span className="visually-hidden">Loading...</span>
                            </div>
                        </div> : <div className="alert alert-success text-center text-dark fs-5 mt-5" role="alert">
